...
public class MyOder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ///////////////////////////////////////////
        Window window = MyOder.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(MyOder.this, androidx.cardview.R.color.cardview_dark_background));
...
fetchUserAddressFromFirestore();
    ...
    private void fetchProductsFromFirestore() {
        ...
        String Email = EmailHolder.getUserEmail();
        productsCollection.whereEqualTo("email", Email).get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
